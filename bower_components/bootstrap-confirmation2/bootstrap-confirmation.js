    ...
    template: '<div class="popover confirmation">' +
      ...
      '<div class="popover-content">' +
        ...
        '<div class="confirmation-buttons text-center">' +
          '<div class="btn-group">' +
            '<a href="#" class="btn" data-apply="confirmation" id="apply-delete"></a>' +
            '<a href="#" class="btn" data-dismiss="confirmation" id="dismiss-delete"></a>' +
          '</div>' +
        '</div>' +
      '</div>' +
    '</div>'
  ...
  Confirmation.prototype.setContent = function() {
    ...
    if (this.options.buttons) {
      ...
      $tip.find('[data-apply="confirmation"]')
        ...
        .off('click')
        .one('click', function(e) {
          if ($(this).attr('href') === '#') { // Hide image on click delete
            //e.preventDefault();
